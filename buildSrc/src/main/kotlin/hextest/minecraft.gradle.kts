...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hextest.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hextest-common-common-refmap.json
        // fixed:   hextest-common.refmap.json
