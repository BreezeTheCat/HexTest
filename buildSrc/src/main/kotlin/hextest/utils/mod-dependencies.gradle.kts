...
abstract class HextestModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HextestModDependenciesExtension>("hextestModDependencies")
